...
def main():
    ...
    epochs = args.epochs
    outpath = args.outpath + '_' + norm_cfg + '_' + activation_cfg  # use this in training and comment out the next
    #outpath = args.outpath                                           # use this in inference and comment out the previous
